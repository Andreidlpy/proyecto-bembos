    ...
    <>
      <footer>
        <div className="footer_social_icons container">
          <a target="_blank" href="https://www.facebook.com/bembos/">
            <img src="/images/face.jpeg" alt="" />
          </a>
          <a target="_blank" href="https://www.youtube.com/user/BembosCanal">
            <img src="/images/yutube.jpeg" alt="" />
          </a>
          <a target="_blank" href="https://twitter.com/BembosOficial">
          ...
          <div className="footer_contacto_libro_container">
            <div className="footer_contacto_container">
              ...
              <div className="footer_contacto">
                <input
                  type="text"
                  className="footer_contacto_input_box"
              ...
              <div className="footer_contacto_terms">
                <input type="checkbox" />
                <label htmlFor="">
                  He leído y revisado los términos y condiciones
                </label>
              </div>
            </div>
